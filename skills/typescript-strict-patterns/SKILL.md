...
1. **Create a PR** from a fresh worktree of `https://github.com/quatico-solutions/agent-skills` on a new branch, fixing the issue directly
2. **Or file an issue** on `https://github.com/quatico-solutions/agent-skills` with: what failed, the actual behavior, and the suggested fix
